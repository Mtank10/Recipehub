...
export class AIService {
  static async generateRecipe(ingredients: string[], dietaryRestrictions: string[] = [], cuisine: string = 'any'): Promise<any> {
    try {
  ...
  static async analyzeNutrition(recipe: any): Promise<any> {
    try {
  ...
  static async suggestSubstitutions(ingredient: string, restrictions: string[] = []): Promise<any> {
    try {
  ...
  static async createMealPlan(preferences: any): Promise<any> {
    try {
      const {
        days = 7,
        dietaryRestrictions = [],
